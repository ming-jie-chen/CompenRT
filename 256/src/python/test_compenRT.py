...
train_option_default = {'max_iters': 1,
                        ...
                        'device': device,
                        'pre-trained': False,
                        'pretrain_csr': '/home/mingjie/code/code/256/checkpoint/bubble_1_CompenHD_l1+l2+ssim+diff_500_4_2000_0.001_0.001_0.5_900_0.0001.pth',
                        'pretrain_cmp': '',
        ...
        for model_name in model_list:
            ...
            for loss in loss_list:
                ...
                if model_name == 'CompenHD': 
                    ...
                    compen_hd = Models.CompenHD(ga_net, pa_net).cuda()
