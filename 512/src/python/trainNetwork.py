...
if __name__ == '__main__':
    ...
    # a=result[0]+F.interpolate(result[1],size=(1024,1024))
#     min_value = torch.min(result[1])
#     max_value = torch.max(result[1])
#     # save_image(pyr_result[-1], 'aa.jpg')
#     # 对张量进行最小-最大归一化
#     normalized_tensor1 = (result[1]- min_value) / (max_value - min_value)
#     save_image(normalized_tensor1, 'a.jpg')
# # a=result[0]+F.interpolate(result[1],size=(1024,1024))
#     min_value = torch.min(result[0])
#     max_value = torch.max(result[0])
#     # save_image(pyr_result[-1], 'aa.jpg')
#     # 对张量进行最小-最大归一化
#     normalized_tensor1 = (result[0]- min_value) / (max_value - min_value)
#     save_image(normalized_tensor1, 'b.jpg')
